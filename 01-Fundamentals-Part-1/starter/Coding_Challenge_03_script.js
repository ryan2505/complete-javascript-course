...
const dolphinsAvg = (dolphinsGameOne + dolphinsGameTwo + dolphinsGameThree) / 3;
const koalasAvg = (koalasGameOne + koalasGameTwo + koalasGameThree) / 3;
...
console.log('Bonus 1 and 2 begins');
